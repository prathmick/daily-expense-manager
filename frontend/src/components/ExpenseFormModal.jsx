...
export default function ExpenseFormModal({ isOpen, onClose, onSuccess, expense }) {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      onSuccess(); onClose();
    } catch (err) { setApiError(err.response?.data?.detail || "Something went wrong"); }
    ...
    <div onClick={e => e.target === e.currentTarget && onClose()} style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
          <h3 style={{ margin: 0, fontSize: 18, fontWeight: 800, color: "#1a1d2e" }}>
        ...
        <form onSubmit={handleSubmit} noValidate>
          ...
          <div style={{ marginBottom: 16 }}>
            ...
            <div style={{ position: "relative" }}>
              ...
              <input type="number" name="amount" value={form.amount} onChange={onChange} onBlur={onBlur}
              ...
              {CATEGORIES.map(c => (
                <button key={c} type="button" onClick={() => { setForm(p => ({ ...p, category: c })); setErrors(p => ({ ...p, category: "" })); }}
                  style={{
                    ...
                    borderColor: form.category === c ? "#4f46e5" : "#e2e8f0",
                    background: form.category === c ? "#ede9fe" : "#fff",
                    color: form.category === c ? "#4f46e5" : "#64748b",
          ...
          <div style={{ marginBottom: 24 }}>
            ...
            <textarea name="description" value={form.description} onChange={onChange} onBlur={onBlur}
              maxLength={255} rows={2} placeholder="What was this for?"
